...
parser.add_argument("--pretrain_model_path_for_test", default="output/model_save_name0/best_model", type=str)
...
parser.add_argument("--test_data_path",default='./mawps/Fold_0/test_mawps_new_mwpss_fold_0.json',type=str)
