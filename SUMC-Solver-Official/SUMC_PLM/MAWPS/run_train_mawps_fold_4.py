...
parser.add_argument("--model_name", default="discriminator4",type=str)
...
parser.add_argument("--discriminator_path", default=None, type=str) #output/discriminator4/best_model
