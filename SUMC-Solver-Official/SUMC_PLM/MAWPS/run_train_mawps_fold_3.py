...
parser.add_argument("--model_name", default="discriminator3",type=str)
...
parser.add_argument("--discriminator_path", default=None, type=str) #output/discriminator3/best_model
